// Globale Variablem
const BASE_URL =
  "https://join-7a4da-default-rtdb.europe-west1.firebasedatabase.app/";
let contacts = [];
let alphabet = [
  "A",
  "B",
...
async function renderContacts() {
  ...
  for (i = 0; i < contacts.length; i++) {
    ...
    document.getElementById(`initialsCircle${i}`).style.backgroundColor =
      contacts[i].backgroundColor;
  }
...
function renderEditArea(i) {
  ...
  document.getElementById(`overlayAbbr`).style.backgroundColor =
    contacts[i].backgroundColor;
}
